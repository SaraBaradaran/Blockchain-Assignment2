...
class Node:
    ...
    def broadcast_next_state(self, min_value):
        ...
        if self.node_id != 1:
            ...
            return
        # Node 1 is malicous and it tells 1 node the correct min_value, while it tells the other 2 nodes a wrong value
        # This way it causes fork since the messages would not be broadcast and each node only send
        # its reply to the primary. As a result, the other nodes don't know what is the actual min value.
